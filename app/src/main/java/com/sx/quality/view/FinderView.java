...
public class FinderView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawLine(100, 100, 100, DensityUtil.getScreenWidth() - 100, linerPaint);
        /**右边线*/
        //canvas.drawLine(leftWidth, topHeight + middleHeight, measureedWidth - leftWidth, topHeight + middleHeight, linerPaint);
        canvas.drawLine(DensityUtil.getScreenHeight() - 100, 100, DensityUtil.getScreenHeight() - 100, DensityUtil.getScreenWidth() - 100, linerPaint);
        /**上边线*/
        //canvas.drawLine(leftWidth, topHeight, measureedWidth - leftWidth, topHeight, linerPaint);
        canvas.drawLine(100, 100, DensityUtil.getScreenHeight() - 100, 100, linerPaint);
        /**下边线*/
        canvas.drawLine(100, DensityUtil.getScreenWidth() - 100, DensityUtil.getScreenHeight() - 100, DensityUtil.getScreenWidth() - 100, linerPaint);//左边线
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        middleRect.set(101, 101, DensityUtil.getScreenHeight()-101, DensityUtil.getScreenWidth()-101);
        /**
         * 上面半透明矩形框
         */
        //topRect.set(Constants.FOCUS_FRAME_ZERO, Constants.FOCUS_FRAME_ZERO, measureedWidth, topHeight);
        topRect.set(100, 0, DensityUtil.getScreenHeight() -100, 100);
        /**
         * 左边半透明矩形框
         */
        //leftRect.set(Constants.FOCUS_FRAME_ZERO, topHeight, leftWidth, topHeight + middleHeight);
        leftRect.set(0, 0, 100, DensityUtil.getScreenHeight());

        /**
         * 右边半透明矩形框
         */
        //rightRect.set(measureedWidth - leftWidth, topHeight, measureedWidth, topHeight + middleHeight);
        rightRect.set(DensityUtil.getScreenHeight() - 100, 0, DensityUtil.getScreenHeight(), DensityUtil.getScreenWidth());
        /**
         * 下边半透明矩形框
         */
        //bottomRect.set(Constants.FOCUS_FRAME_ZERO, topHeight + middleHeight, measureedWidth, measureedHeight);
        bottomRect.set(100, DensityUtil.getScreenWidth(), DensityUtil.getScreenHeight()-100, DensityUtil.getScreenWidth()-100);
    }
}
